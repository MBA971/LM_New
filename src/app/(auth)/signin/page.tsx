...
export default function SignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Actual next-auth signIn function
        ...
        <div className="text-center text-sm text-slate-500">
          ...
          <div className="flex items-center justify-center mt-3">
            <a href="#" className="flex items-center justify-center w-10 h-10 rounded-md border border-slate-200 hover:border-slate-300">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-6 h-6 text-slate-500"><path fill="currentColor" d="M24 12c2.21 0 4.17.81 5.65 2.04l4.77-4.77C31.95 5.48 28.05 4 24 4 13.25 4 4 13.25 4 24s9.25 20 20 20 20-9.25 20-20S34.75 4 24 4zm0 42c-9.94 0-18-8.06-18-18s8.06-18 18 18-8.06 18-18 18z"/></svg>
            </a>
